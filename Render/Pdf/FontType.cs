namespace Fonet.Render.Pdf
{
    ...
    ///     </p>
    ///     <p>
    ///         The <see cref="FontType.Link" /> member specifies that all fonts
    ...
    ///     </p>
    ///     <p>
    ///         The <see cref="FontType.Embed" /> option will copy the contents of
    ...
    ///     </p>
    ///     <p>
    ///         Finally, the <see cref="FontType.Subset" /> option will only copy the required
