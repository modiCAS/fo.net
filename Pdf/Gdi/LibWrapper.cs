...
namespace Fonet.Pdf.Gdi
{
    internal sealed class LibWrapper
    {
        ...
        internal static extern uint GetFontData(
            ...
            [MarshalAs( UnmanagedType.LPArray )] byte[] lpvBuffer, // buffer for returned data
            uint cbData // length of data
            );

        [DllImport( "gdi32.dll", CharSet = CharSet.Auto )]
        internal static extern int AddFontResourceEx(
            [In] [MarshalAs( UnmanagedType.LPTStr )] string lpszFilename, // font file name
        ...
        internal static extern bool RemoveFontResourceEx(
            [In] [MarshalAs( UnmanagedType.LPTStr )] string lpFileName, // name of font file
            uint fl, // font characteristics
            int pdv // Reserved.
            );
        ...
        internal static extern IntPtr CreateFontIndirect(
            [MarshalAs( UnmanagedType.LPStruct )] LogFont lplf // characteristics
            );
        ...
        internal static extern uint GetGlyphIndices(
            ...
            [MarshalAs( UnmanagedType.LPArray )] ushort[] pgi, // array of glyph indices
        ...
        internal static extern uint GetFontUnicodeRanges(
            IntPtr hdc, // handle to DC
            [Out] [MarshalAs( UnmanagedType.LPStruct )] GlyphSet lpgs // glyph set
            );
        ...
        internal static extern int GetTextFace(
            ...
            [MarshalAs( UnmanagedType.LPTStr )] StringBuilder lpFaceName // typeface name buffer
            );
...
//        );
        ...
        internal static extern int EnumFontFamilies(
            IntPtr hdc, // handle to DC
            [MarshalAs( UnmanagedType.LPTStr )] string lpszFamily, // font family
